(()=>{
  ...
  function cropPortrait(img){
    const file=decodeURIComponent(img.src.split('/').pop()),bounds=PORTRAIT_BOUNDS[file],head=PORTRAIT_HEADS[file.replace('.webp','')];if(!bounds||!head)return;
  ...
  const MASKED_PORTRAITS=new Set(["ch1_supervisor.webp","ch2_captain.webp","ch2_euro_trader.webp","ch1_manager.webp","ch2_lover_panicked.webp"]);
